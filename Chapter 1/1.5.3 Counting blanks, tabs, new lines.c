...
int main(){
	...
	/* As per EOF is end of file, first version of the task sollution should be commented for second version proper work. */
	/* This example is good for understanding that EOF is actually end-of-file for the program stdin, so it makes */
	/* all further `getchar()` attempts be irrelewant and equal -1, which represents EOF numeric value. */
        c = 0; 
